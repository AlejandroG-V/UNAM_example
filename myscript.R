...
#From domain knowledge of the data, we know that a good model for it is the equation p1*cos(p2*xdata)+p2*sin(p1*xdata)
#We need to find the values for the parameters p1 and p2. 
